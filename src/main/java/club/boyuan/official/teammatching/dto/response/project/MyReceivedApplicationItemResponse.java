...
/**
 * 当前用户收到的入队申请记录（用于项目发布者视角）
 */
@Data
@ApiModel(value = "我收到的申请记录项")
public class MyReceivedApplicationItemResponse {
    ...
    @ApiModelProperty(value = "申请岗位/角色")
    private String role;
    ...
    @ApiModelProperty(value = "投递简历文件 ID")
    private Long customResumeFileId;

    @ApiModelProperty(value = "投递附件文件 ID")
    private Long applicationAttachmentFileId;

    @ApiModelProperty(value = "与申请人的会话 ID（无则 null）")
